...
const AdminDashboard = () => {
  ...
  const fetchActiveSubscribersCount = async () => {
    try {
            ...
            {dataLoading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                  ...
                  <div className="p-5 bg-slate-900 border border-slate-850 rounded-2xl flex flex-col justify-between shadow-md">
                    <div className="flex items-center justify-between text-slate-500 mb-4">
                      <span className="text-xs uppercase tracking-wider font-bold">Subscribers</span>
                      <Users className="w-5 h-5 text-emerald-400" />
                    </div>
                    <div>
                      <span className="text-3xl font-extrabold text-white">{activeSubscribersCount}</span>
                      <span className="block text-[10px] text-slate-500 mt-1">Active blog list</span>
                    </div>
                  </div>
                </div>
